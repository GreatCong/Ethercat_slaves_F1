...
//	#define CSHIGH()     DESELECT_SPI
	#define CSLOW()      	HAL_GPIO_WritePin(ETHERCAT_CS_GPIO_Port,ETHERCAT_CS_Pin,GPIO_PIN_RESET)
	#define CSHIGH()     	HAL_GPIO_WritePin(ETHERCAT_CS_GPIO_Port,ETHERCAT_CS_Pin,GPIO_PIN_SET);
