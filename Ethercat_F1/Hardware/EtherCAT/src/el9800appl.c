...
//	}
   ...
   //CMD控制电机
	 switch(cmd[1]){
		case 0:{data[1] = 0;PWM_stop(0);cmd[1]=-1;;break;}
		case 1:{data[1] = PWM_Set(0,data[1]+100);cmd[1]=-1;break;}//需要修改主站的代码，让主站的控制信号为脉冲式而非电平式持续触发，否则会在短时间内累加到最大值
		case 2:{data[1] = PWM_Set(0,data[1]-100);cmd[1]=-1;break;}
		case 3:{data[1] = PWM_Set(0,10000);cmd[1]=-1;break;}
